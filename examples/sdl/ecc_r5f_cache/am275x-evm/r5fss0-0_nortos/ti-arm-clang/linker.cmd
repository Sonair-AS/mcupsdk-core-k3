...
SECTIONS
{
    ...
    .DATA_Cache.buffer  : {} > R50_0_OCRAM_Cache
}
...
MEMORY
{
    ...
    R5F_TCMB       (RWIX)        : ORIGIN = 0x41010000 LENGTH = 0x00008000

    WKUP_R5_OCRAM (RWIX)         : ORIGIN = 0x72000000 LENGTH = 0x00080000 // 512 KB for wakeup core

    R50_0_OCRAM   (RWIX)         : ORIGIN = 0x72080000 LENGTH = 0x80000 // 512 KB for r5fss0-0 core
    R50_0_OCRAM_Cache   (RWIX)         : ORIGIN = 0x72100000 LENGTH = 0x80000 // 512 KB for r5fss0-0 core
